...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    # primary.item :key_1, 'name', url, options do |sub_nav|
      # Add an item to the sub navigation (same params again)
      # sub_nav.item :key_1_1, 'name', url, options
    # end
    ...
    primary.item :rankings, t('shared.navbar.rankings'), rankings_path, highlights_on: :subpath
